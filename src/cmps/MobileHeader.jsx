...
import { MobileSearchBarForm } from "./MobileSearchBarForm"
...
export function MobileHeader() {
    ...
    return (
        <header className="mobile-header full flex align-center">
            <div className="mobile-search-bar flex align-center" onClick={() => setIsMobileSearchBarOpen(true)}>
            ...
            {isMobileSearchBarOpen && <MobileSearchBarForm
